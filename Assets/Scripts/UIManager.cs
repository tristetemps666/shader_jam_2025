...
public class UIManager : MonoBehaviour
{
    ...
    public void StartGame()
    {
        ...
        OnMainMenuFadeEnd.AddListener(()=>StartCoroutine(FadeGroup(_instructionsCanvasGroup, true,OnInstructionFadeInEnd)));
    }
    ...
    private IEnumerator FadeGroup(CanvasGroup groupToFade,bool fadeIn, UnityEvent? eventToCall = null)
    {
